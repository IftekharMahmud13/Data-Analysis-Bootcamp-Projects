...
-- Selecting Data that are going to be starting with
...
-- Shows the likelihood of dying if anyone contract covid in your country
...
-- Just for confirmation the table  is created or not
select *
From #PercentPopulationVaccinated
